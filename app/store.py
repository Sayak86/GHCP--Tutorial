...
SEED_FILE = Path(__file__).resolve().parent.parent / "data" / "seed_payments.json"


class PaymentStore:
    """In-memory payment store seeded from a JSON fixture (our stand-in for a data page)."""

    def __init__(self) -> None:
        self.reset()

    def reset(self) -> None:
        payments = json.loads(SEED_FILE.read_text())
